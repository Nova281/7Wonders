...
public class GreenCard extends Card {
	...
	private void assignScience() {
		if (getName().equals("Apothecary") || getName().equals("Dispensary") || getName().equals("Lodge")
				|| getName().equals("Academy")) {
			science = "math";
		} else if (getName().equals("Workshop") || getName().equals("Laboratory") || getName().equals("Observatory")
