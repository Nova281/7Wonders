...
public class GamePanel extends JPanel {
	...
	public void paintComponent(Graphics g) {
		...
		String resourceFile = "/wonder_resource/" + playerList[(currentPlayer + 2) % 3].getWonder().getResource()
				+ ".jpg";
		try {
		...
		resourceFile = "/wonder_resource/" + playerList[(currentPlayer + 3) % 3].getWonder().getResource() + ".jpg";
		try {
		...
		resourceFile = "/wonder_resource/" + playerList[(currentPlayer + 4) % 3].getWonder().getResource() + ".jpg";
		try {
	...
	public void setWonderImages(Player[] players) throws IOException {
		for (int i = 0; i < wonderList.length; i++) {
			...
			imgList[i] = ImageIO
					.read(getClass().getResource("/wonder_boards/" + players[i].getWonder().getName() + ".jpg"));
		}
		playerList = players;
	}
