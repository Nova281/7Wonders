...
public class GamePanel extends JPanel {
	...
	public GamePanel(ArrayList<Player> playerList) throws IOException, FontFormatException {
	 ...
	 * new BufferedImage[currentPlayerHand.size()]; for (Card c : currentPlayerHand)
